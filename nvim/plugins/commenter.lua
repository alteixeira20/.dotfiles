...
--                                                +#+#+#+#+#+   +#+           --
--   Created: 2024/11/06 13:27:21 by paalexan          #+#    #+#             --
--   Updated: 2024/11/06 14:46:54 by paalexan         ###   ########.fr       --
--                                                                            --
-- -------------------------------------------------------------------------- --

function add_boxed_comment()
    ...
    elseif filetype == "lua" then
        ...
        comment_end = " //"
        fill_char = "*"
        vim.notify("File type is not configured. Using '//' style. Add your preferences to commenter plugin", vim.log.levels.WARN)
    end
